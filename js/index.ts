...
class Core {
	...
	/*
	 * Starting the whole backend
	 * It loads configs
	 * starts backend modules (helpers)
	 * setups endpoints
	 */
	async start(): Promise<void> {
		...
		// starting server that creates endpoints and servers files to clients
